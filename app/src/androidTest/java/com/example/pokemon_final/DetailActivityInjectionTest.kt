package com.example.pokemon_final
...
import com.pokedex.ui.details.DetailActivity
import com.pokedex.utils.MockUtil
...
class DetailActivityInjectionTest {
    ...
    fun verifyInjection() {
        ...
        intent.putExtra("com.transformationlayout", transformationLayout.getParcelableParams())
